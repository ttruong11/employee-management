...
const LoginForm = () => {
  ...
  const [showSignupForm, setShowSignupForm] = useState(false); // State to toggle SignupForm visibility
          ...
          {showSignupForm ? (
            ...
            <form onSubmit={handleLogin}>
              ...
              <button 
                ...
                onClick={() => setShowSignupForm(true)} // Show the SignupForm when clicked
              >
                Sign-up
              </button>
